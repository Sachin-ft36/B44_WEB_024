    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div className="md:col-span-1">
            <h5 className="font-poppins font-bold text-lg mb-4">Quick Links</h5>
          ...
          {/* Support */}
          <div className="md:col-span-1">
            <h5 className="font-poppins font-bold text-lg mb-4">Support</h5>
            <ul className="space-y-2">
              <li>
                <Link to="#" className="text-gray-400 hover:text-white transition-colors">
                  Help Center
          ...
          {/* Contact */}
          <div className="md:col-span-1">
            <h5 className="font-poppins font-bold text-lg mb-4">Contact</h5>
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@sessi.org" className="text-gray-400 hover:text-white transition-colors">
                  info@sessi.org
                </a>
              </li>
              <li className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} SESSI. All rights reserved.
          </p>
